...
public class LightContainer {
    ...
    public LightContainer(Light type) {
        ...
        this.lightValues.put(HALFANGLE, new SimpleDoubleProperty(0.0));
    ...
    public double getValue(String key) {
        try {
            SimpleDoubleProperty s = (SimpleDoubleProperty) this.lightValues.get(key);
            return s.getValue();
        } catch (Exception e) {
    ...
    public boolean getCastsShadow() {
        SimpleBooleanProperty s = (SimpleBooleanProperty) lightValues.get(CASTSSHADOW);
        return s.getValue();
    }
