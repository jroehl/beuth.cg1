...
public enum Camera {
	...
	private final Double[] initialValues = {calcHelper.getMultipliedValue(0.0), calcHelper.getMultipliedValue(0.0),
			calcHelper.getMultipliedValue(-4.0), calcHelper.getMultipliedValue(0.0), calcHelper.getMultipliedValue(0.0),
			calcHelper.getMultipliedValue(1.0), calcHelper.getMultipliedValue(0.0), calcHelper.getMultipliedValue(1.0),
			calcHelper.getMultipliedValue(0.0), calcHelper.getMultipliedValue(4.0)};
