...
public class RayTracerMainController {
	...
	private void initializeListeners() {
		...
		nodeLabels = new Label[]{labelTransX, labelTransY, labelTransZ, labelScaleX, labelScaleY, labelScaleZ, labelTranslateX,
