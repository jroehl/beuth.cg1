...
/**
 * Die abstrakte Basisklasse Camera speichert die drei Vektoren u, v und w, welche vom Konstruktor entgegen genommen werden. Im Konstruktor
 * werden hieraus die Vektoren u,v und w berechnet, welche ebenfalls als öffentliche Attribute zur Verfügung gestellt werden.
 * Die abstrakte Klasse Camera deklariert die Methode rayFor, welche für einen bestimmten Pixel den Strahl zurückgibt.
 * Die Parameter w und h geben hierbei die Höhe und Breite des Bildes an. Die Parameter x und y geben die Koordinaten des Pixels an,
 * für den der Strahl generiert werden soll.
 */
public abstract class Camera {
     ...
     * Konstruktor: Camera
     *
     * @param e Point3 der Kamera
     * @param g Vector3 der Kamera
     * @param t Vector3 der Kamera
     *
     ...
     * Method: rayFor
     *
     * @param w int der Kamera
     * @param h int der Kamera
     * @param x int der Kamera
     * @param y int der Kamera
     * @return null
     */
