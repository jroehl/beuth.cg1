 ...
 *         <p>
 *         Die von Geometry abgeleitete Klasse Sphere implementiert
...
public class Sphere extends Geometry {
     ...
     * @param center Point3 Objekt der Ebene
     * @param radius double wert der Sphere
     * @throws IllegalArgumentException
     */
    public Sphere(Color color, Point3 center, double radius) throws IllegalArgumentException {
        super(color);
